...
module.exports = {
	...
	example: 'ET :AwesomeParty: [19 May 16:30] (EN14) #et-1 $TANK PRIEST DPS RANGED WIZ Any$',
	notes: 'After creation there will be 5 character ID for each party. Use it for other commands.\n' +
		...
		'- *_$Roles$_* in between * * are optional. If you don\'t specify, roles will be set to default TANK PRIEST DPS DPS DPS DPS \n' +
