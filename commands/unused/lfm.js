...
const lfmET = func.lfmET;
const ET_TYPE = varFile.ET_TYPE;
const prefix = varFile.CMD_PREFIX;

module.exports = {
	name: 'lfm',
	description: 'This command is for searching missing roles for existing ET party.',
	format: 'ET partyID',
	example: 'ET se42GD',
	group: 'party-finder',
	...
	execute(message, args) {
		...
		if (args.length > 0 && isDefined(instance)) {
			...
			default:
				...
				message.channel.send('Please use ' + varFile.CMD_PREFIX + 'lfm **ET** PartyID.');
				break;
			}
